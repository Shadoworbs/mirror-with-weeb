...
try:
    ...
    if len(GD_INFO) == 0:
        GD_INFO = 'Uploaded by Mirror With Weeb'
except KeyError:
    GD_INFO = 'Uploaded by Mirror With Weeb'
...
try:
    ...
    if len(TITLE_NAME) == 0:
        TITLE_NAME = 'Mirror With Weeb-Search'
except KeyError:
    TITLE_NAME = 'Mirror With Weeb-Search'
